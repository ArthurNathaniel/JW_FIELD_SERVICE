...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        $sql = "UPDATE members SET reset_code = ?, reset_code_expiry = ? WHERE email = ?";
        $stmt = $conn->prepare($sql);
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('forgot-password-form').addEventListener('submit', function(event) {
            ...
            fetch('forgot_password_member.php', {
                method: 'POST',
                body: formData
            })
            ...
            .then(data => {
                ...
                if (data.message.includes("sent to your email")) {
                    ...
                    .then(function(response) {
                        ...
                        window.location.href = 'reset_password_member.php'; // Redirect to reset password page
                    }, function(error) {
